...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsContainer = __webpack_require__(223);

	var _componentsContainer2 = _interopRequireDefault(_componentsContainer);

	var _componentsTweetList = __webpack_require__(224);

	var _componentsTweetList2 = _interopRequireDefault(_componentsTweetList);

	// Combined Reducers

	var _reducersReducers = __webpack_require__(231);
	...
	var store = createStoreWithMiddleware(_reducersReducers2['default']);
	...
	(0, _reactDom.render)(_react2['default'].createElement(
	  ...
	  _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(
	      _reactRouter.Route,
	      { path: '/', component: _componentsContainer2['default'] },
	      _react2['default'].createElement(_reactRouter.IndexRoute, { component: _componentsTweetList2['default'] }),
	      _react2['default'].createElement(_reactRouter.Route, { path: '*', component: _componentsTweetList2['default'] })
	    )
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TweetList = __webpack_require__(224);

	var _TweetList2 = _interopRequireDefault(_TweetList);

	var _Tweet = __webpack_require__(225);

	var _Tweet2 = _interopRequireDefault(_Tweet);

	var _reactRedux = __webpack_require__(215);

	var _actionsActions = __webpack_require__(226);
	...
	var Container = (function (_Component) {
	  ...
	  _createClass(Container, [{
	    ...
	    value: function handleClick(e) {
	      ...
	      var node = _reactDom2['default'].findDOMNode(this.refs.twitterHandle);
	      var user = this.refs.twitterHandle.value;
	      dispatch((0, _actionsActions.fetchTweets)(user));
	      node.value = '';
	      node.focus();
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var listOfTweets = this.props.listOfTweets;
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('input', {
	          ...
	          onKeyDown: function (e) {
	            if (e.keyCode === 13) _this.handleClick(e);
	          }
	        }),
	        _react2['default'].createElement(
	          'button',
	      ...
	      if (this.props.listOfTweets.length) {
	        if (this.props.listOfTweets[0].error) {
	          return _react2['default'].createElement(
	            'div',
	            null,
	            'The Twitter handle you entered does not exist.'
	          );
	        } else {
	          return _react2['default'].createElement(
	            'ul',
	            ...
	            _react2['default'].createElement(
	              ...
	              { className: 'userName' },
	              '@',
	              this.props.listOfTweets[0].user.screen_name
	            ),
	            this.props.listOfTweets.map(function (tweet, index) {
	              return _react2['default'].createElement(_Tweet2['default'], _extends({}, tweet, { key: index }));
	            })
	          );
	        }
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./Container.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./Container.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	function listOfTweets(state, action) {
	  ...
	  switch (action.type) {
	    case _actionsActions.RECEIVE_TWEETS:
